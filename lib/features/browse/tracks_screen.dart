...
/// Library entry point (bottom tab: Tracks).
///
/// Contains the migrated browse sections (Playlists / Albums / Artists).
/// The title contains a visible one-line switcher (Playlists | Albums | Artists).
...
class _TracksScreenState extends ConsumerState<TracksScreen> {
  ...
  Widget _sectionSwitcher() {
    // Keep it one-line and always visible (Playlists | Albums | Artists).
    // On narrow screens, scale down slightly instead of wrapping.
    return FittedBox(
  ...
  Widget build(BuildContext context) {
    ...
    final titleWidget = _sectionSwitcher();
    ...
    return RefreshIndicator(
      ...
      child: CustomScrollView(
        ...
        slivers: [
          ...
          // Add a little breathing room above the mini-player.
