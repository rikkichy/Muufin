...
class _PlayerScreenState extends ConsumerState<PlayerScreen> {
  ...
  void _close(BuildContext context) {
    // Works with both Navigator + GoRouter.
    ...
    return Scaffold(
      body: stateAsync.when(
        data: (s) {
          ...
          return ColoredBox(
            // Keep the "Now playing" page clean and neutral; no background gradient.
            color: cs.surface,
            child: NotificationListener<ScrollNotification>(
              onNotification: (n) {
                // "Swipe down to close" without fighting normal scrolling:
                // only triggers when you overscroll at the very top.
                if (n is OverscrollNotification) {
                  ...
                  // Any real scroll cancels the gesture.
              ...
              child: CustomScrollView(
                slivers: [
                  ...
                  // Small grab handle hinting that you can pull down to close.
                  SliverToBoxAdapter(
                    child: Padding(
