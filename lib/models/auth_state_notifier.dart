...
class AuthStateNotifier extends AsyncNotifier<AuthState> {
  ...
  Future<void> login({
    ...
    try {
      ...
      await _completeLogin(baseUrl, result, disableTls, prev);
    } catch (e, st) {
  ...
  Future<void> _completeLogin(String baseUrl, AuthResult result, bool disableTls, AuthState prev) async {
