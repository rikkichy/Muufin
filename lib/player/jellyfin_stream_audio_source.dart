...
/// Streams Jellyfin audio through Dart so we can attach Authorization headers on
/// platforms where the native player can't (notably Windows).
class JellyfinStreamAudioSource extends StreamAudioSource {
  ...
  Future<StreamAudioResponse> request([int? start, int? end]) async {
    ...
    // Figure out lengths/offsets. Jellyfin typically supports range requests.
    ...
    // Fallback if server didn't include Content-Range.
